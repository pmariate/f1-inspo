...
public class JavaApplication5 extends JPanel{
    ...
    public void paint(Graphics g){
        ...
        try{
           ...
           obj.drawImage(getToolkit().getImage("C:\\Users\\Acer\\Desktop\\Workspace2\\inspo\\src\\images\\st_road.png"), 0,0 ,this); //draw road on window
            ...
            if(cry >= -499 && crx >= -499) {//if a road crossing has passed the window view
                obj.drawImage(getToolkit().getImage("C:\\Users\\Acer\\Desktop\\Workspace2\\inspo\\src\\images\\cross_road.png"),crx,cry,this); //draw another road crossing on window
                    obj.drawImage(getToolkit().getImage("C:\\Users\\Acer\\Desktop\\Workspace2\\inspo\\src\\images\\cross_roadnew.png"),crx,cry,this); //draw another road crossing on window
            }
            obj.drawImage(getToolkit().getImage("C:\\Users\\Acer\\Desktop\\Workspace2\\inspo\\src\\images\\car_right_1.png"),car_x,car_y,this);   //draw car on window

            if(isFinished){ //if collision occurs
                obj.drawImage(getToolkit().getImage("C:\\Users\\Acer\\Desktop\\Workspace2\\inspo\\src\\images\\boom.png"),car_x-30,car_y-30,this); //draw explosion image on window at collision to indicate the collision has occured
            }
    ...
    public static void main(String args[]){
        ...
        while(true){
            ...
            if(game.nOpponent < 4 && count % 200 == 0){ //if there is less than 4 cars and count timer reaches 200
                ...
                game.imageLoc[game.nOpponent] = "C:\\Users\\Acer\\Desktop\\Workspace2\\inspo\\src\\images\\car_left_"+((int)((Math.random()*100)%3)+1)+".png"; //assign images to the opponent cars
